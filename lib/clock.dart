...
class Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint centerFillBrush = Paint()..color = mainColor;
    ...
    double secondX =
        centerX + (secondRadius * cos(dateTime.second * 6 * pi / 180));
    double secondY =
        centerY + (secondRadius * sin(dateTime.second * 6 * pi / 180));

    double minuteX =
        centerX + (minuteRadius * cos(dateTime.minute * 6 * pi / 180));
    double minuteY =
        centerY + (minuteRadius * sin(dateTime.minute * 6 * pi / 180));
